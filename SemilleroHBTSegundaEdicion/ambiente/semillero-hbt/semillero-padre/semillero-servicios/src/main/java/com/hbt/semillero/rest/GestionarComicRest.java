...
public class GestionarComicRest {
	...
	@Path("/eliminar")
	@Produces(MediaType.APPLICATION_JSON)
	public void eliminarComic(ComicDTO comicDTO) {
		if (comicDTO.getId() != null) {
			 comicDTO = gestionarComicEJB.consultarComic(comicDTO.getId());

		}
		gestionarComicEJB.eliminarComic(Long.valueOf(comicDTO.getId()));
	}
}
